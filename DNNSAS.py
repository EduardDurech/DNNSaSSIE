...
#dat_trgt = "C:/Users/BORG-AO-Ref/Documents/CommercialSaSSIE/train/gt_res/"
...
"""
for dir_adr in dir_titles:
	for adr in next(os.walk(dat_set+"/"+dir_adr))[2]:
		train_ids.append(dir_adr+"-"+adr)
"""

X_train = np.zeros((len(dir_titles), 10, 512, 512))
Y_train = np.zeros((len(dir_titles), 512, 512))
